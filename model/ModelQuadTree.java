...
public class ModelQuadTree {
	 ...
	 * @throws IOException 
	 */
	public ModelQuadTree(Controller controller, Regles regles) {
	 ...
	 * @throws IOException 
	 */
	public ModelQuadTree(Controller controller) {
	 ...
	 */
	public QuadTree getCellulesVivantes(){
	 ...
	 */
	public ModelQuadTree avecCellules(Cellule... cellules) {
